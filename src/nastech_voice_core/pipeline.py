"""High-level TTS interface for Nastech Voice Core.
...
class TTS:
    """High-level interface for Nastech Voice Core text-to-speech synthesis.
    ...
    Attributes:
        model (supertonic.core.Nastech Voice Core): The underlying Nastech Voice Core engine
    ...
    def get_voice_style(self, voice_name: str) -> Style:
        ...
        Args:
            voice_name: Name of the voice style. Nastech Voice Core ships with

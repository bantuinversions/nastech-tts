...
run = Path(
    "/home/ubuntu/nastech-tts/data/common_voice_luganda/experiment_v22_5voice/coqui/smoke-checkpoints/nastech_luganda_vits_common_voice_five_speakers-August-16-2026_01+46PM-0000000"
)
model = TTS(
    model_path=str(run / "best_model_5.pth"),
    config_path=str(run / "config.json"),
    progress_bar=False,
    gpu=False,
)
text = "Nastech etegeka tekinologiya eyamba abantu okwogera Luganda."
out = run / "smoke_samples"
